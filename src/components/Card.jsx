    ...
    return (
        <main className="Card">
            <section className="CardImg">
                <picture>
                    <source media="(min-width:647px)" srcSet="./images/image-product-desktop.jpg"/>
                    <img src="./images/image-product-mobile.jpg" alt="Flowers"/>
                </picture>
            </section>
            <section className="CardProduct">
                ...
                <button className="Card-AddCard fw700">
                    <img src="./images/icon-cart.svg" alt="icon-cart" className="icon"/> 
                    Add to Cart
                </button>
            </section>
        </main>
